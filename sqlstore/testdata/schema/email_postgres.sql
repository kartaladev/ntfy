...
CREATE TABLE IF NOT EXISTS "ntfy_email_deliveries" (
    ...
    CONSTRAINT "ntfy_email_deliveries_pkey" PRIMARY KEY ("notification_id")
);

-- Finding leases that lapsed.
CREATE INDEX IF NOT EXISTS "ntfy_email_deliveries_lease_idx"
    ON "ntfy_email_deliveries" ("status", "lease_until");
